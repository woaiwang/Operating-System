...
extern void ifree(unsigned int dinodeid);
extern unsigned int namei(const char *name);
extern unsigned short iname(const char *name);
extern unsigned int access(int user_id, struct inode *inode, unsigned short mode);
extern void _dir(void);
extern void mkdir(char *dirname);
extern void chdir(char *dirname);
extern unsigned short aopen(int user_id, const char *filename, unsigned short openmode);
extern unsigned short creat(int user_id, const char *filename, unsigned short mode);
extern unsigned int read(unsigned short fd, char *buf, unsigned int size);
extern unsigned int write(unsigned short fd, const char *buf, unsigned int size);
...
extern void close(int user_id, unsigned short cfd);
